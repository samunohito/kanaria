...
#[unsafe(no_mangle)]
#[allow(unused_variables, non_snake_case)]
pub unsafe extern fn Java_com_kanaria_utils_WidthUtils_convertToWideNative(env: JNIEnv, class: jclass, target: jchar, next: jchar, is_pad: jbooleanArray) -> jchar { unsafe {
...
#[unsafe(no_mangle)]
#[allow(unused_variables, non_snake_case)]
pub unsafe extern fn Java_com_kanaria_utils_WidthUtils_convertToNarrowNative(env: JNIEnv, class: jclass, target: jchar, out_char: jcharArray) -> jchar { unsafe {
